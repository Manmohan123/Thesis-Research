...
NP-Hard~\cite{GareyJohnson79}. We have used Graham's List Scheduling
...
assign it to the processor having least load at that time. LS is
...
ratio as $\frac{4}{3}-\frac{1}{3m}$ in an offline setting. One can
...
classification to understand size-based policies and draw analytical
