...
\hline
Model & Approximation ratio & Replication \\
\hline
$|M_j|=1$ & $\frac{C_{max}}{C_{max}^{*}}\leq \frac{2\alpha^{2}m}{2\alpha^{2}+ m-1}$ [Theorem 1.2] & No Replication \\
 & No approximation better than $\alpha^2$ [Thoerem 1.1] &  \\

\hline
$|M_j|=|M|$ & $\frac{C_{max}}{C_{max}^{*}} \leq 1 + (\frac{m-1}{m})\frac{\alpha^{2}}{2}$ [Theorem 2.1] &  Replication everywhere \\

 \hline
 
 $|M_j|= m/k $ & $\frac{C_{max}}{C_{max}^{*}} \leq \frac{k\alpha^{2}}{\alpha^{2}+k-1}\left[1+ {\frac{k-1}{m}} \right]+ {\frac{m-k}{m}}$ [Theorem 3.1] &  Replication in groups \\
  & $\frac{C_{max}}{C_{max}^{*}} \leq  1+ \frac{2}{1+\alpha^{2}} \left(\alpha^2-\frac{1}{m}\right)$ when $k=2$ [Corollary 3.1] &  \\
...
\begin{figure}[htp]
\centering
\includegraphics[width= 8 cm]{graph2}
\caption{Graph 1}
\label{}
\end{figure}
...
\begin{figure}[htp]
\centering
\includegraphics[width= 8 cm]{graph3}
\caption{Graph 2}
\label{}
\end{figure}
...
\begin{figure}[htp]
\centering
\includegraphics[width= 8 cm]{graph5}
\caption{Graph 3}
\label{}
\end{figure}
