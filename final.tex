...
information is typically not precisely known in practice: the user can
only make a wild guess~\cite{Luong2008}, prediction is hard in the
general case~\cite{Wilhelm2008}, or underlying models of a particular
algorithm can only predict a given range~\cite{Erlebacher14-ICS}. 
...
optimal makespan of a schedule $S$.
...
we have used these algorithms accordingly. \todo{PTAS from hochbaum shmoys}~\cite{doi:10.1137/0217033}
