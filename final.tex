...
processing time $\tilde{p_j}$. (An inaccuracy of the throughput of the system leads to a multiplicative factor and that any interval of confidence of a runtime can be transformed into a value and a multiplicative error.) $\alpha$ is a quantity known to the
...
scenario where processing times of tasks either increase or decrease
