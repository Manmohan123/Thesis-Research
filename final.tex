...
\begin{theorem}
For the model having $|M_j| = 1$, there
...
\begin{theorem}
The \textbf{LPT-No Choice} have competitive ratio of $ \frac{2\alpha^{2}m}{2\alpha^{2}+ m-1}$.
\end{theorem} 
...
\begin{lemma}
 LPT-No Restriction has a makespan of at least $ {\frac{2}{\alpha^{2}}} p_l $ when there are at least two tasks on the machine to which the last task $l$ is scheduled. 
\end{lemma}
\begin{proof}
